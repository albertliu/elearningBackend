...
<div id='layout' align='left' style="background:#f0f0f0;width:1000px;">	
	...
	<div style="width:100%;float:left;margin:0;">
		...
		<div id="resume_print" style="border:none;width:100%;margin:1px;background:#ffffff;line-height:18px;">
			<div style='text-align:center; margin:10px 0 20px 0;'><h3 style='font-size:1.45em;'>建筑施工特种作业人员安全技术培训考核初训报名表</h3></div>
			<div style='margin: 12px;text-align:left; width:95%;'><span style='font-size:1.2em;'>操作工种：<span style='font-size:1.2em;' id="courseName"></span><span style='font-size:1.2em;'></span>学员编号：</span><span style='font-size:1.2em;' id="SNo"></span></div>
			<table class='table_resume' style='width:99%;'>
			<tr>
				<td align="center" class='table_resume_title' width='18%' height='48px;' colspan="2">姓名</td><td align="center" width='27%'><p style='font-size:1em;' id="name"></p></td>
				<td align="center" class='table_resume_title' width='15%'>性别</td><td align="center" width='15%'><p style='font-size:1em;' id="sexName"></p></td>
				<td align="center" class='table_resume_title'>身份证号</td><td align="center" width='30%'><p style='font-size:1em;' id="username"></p></td>
				<td rowspan="4" align="center" class='table_resume_title' width='25%'>
					<img id="img_photo" src="" value="" style='width:100px;border:none;' />
				</td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' colspan="2">文化程度</td><td class='table_resume_title'><p style='font-size:1em;' id="educationName"></p></td>
				<td align="center" class='table_resume_title'></td><td align="center"></td>
				<td align="center" class='table_resume_title'>联系人</td><td align="center"></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' height='48px;' colspan="2">工作单位</td><td align="center" colspan="3"><p style='font-size:1em;' id="company"></p></td>
				<td align="center" class='table_resume_title'>单位电话</td><td align="center"></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' height='48px;' colspan="2">单位地址</td><td align="center" colspan="3"><p style='font-size:1em;'>上海市______区</p></td>
				<td align="center" class='table_resume_title'>联系人手机</td><td align="center"><p style='font-size:1em;' id="mobile"></p></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='4%' height='48px;'>特种作业人员应当符合条件</td>
				<td align="left" colspan="6">
					1、年满18周岁，且不超过国家法定退休年龄；</br>
					2、具有初中及以上文化程度；</br>
					3、具备必要的安全技术知识与技能；</br>
					4、相应特种作业规定的其他条件；
					5、有规定实习经历的人员。
					6、经社区或者县级以上医疗机构体检健康合格，并无妨碍从事相应特种作业的器质性心脏病、癫痫病、美尼尔氏症、眩晕症、癔病、震颤麻痹症、精神病、高血压、恐高症、痴呆症以及其他疾病和生理缺陷；
					<p style='font-size:2em;' align="center">注：以上信息由学员单位负责确认加盖公章后再报名培训</p>
				</td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' colspan="7" height='120px;'>
					<p style='font-size:1.4em;'>承 诺 书</p>
				</td>
			</tr>
