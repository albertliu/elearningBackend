...
<script language="javascript">
	...
	function getStudentSMSList(){
		//alert(refID + ":" + nodeID);
		$.get("studentCourseControl.asp?op=getStudentSMSList&nodeID=" + nodeID + "&refID=" + refID + "&times=" + (new Date().getTime()),function(data){
			//alert(unescape(data));
			var ar = new Array();
			...
			arr.push("<th width='40%'>信息内容</th>");
			arr.push("<th width='14%'>发送日期</th>");
			arr.push("<th width='12%'>发送人</th>");
			arr.push("<th width='12%'>手机</th>");
			arr.push("</tr>");
			arr.push("</thead>");
