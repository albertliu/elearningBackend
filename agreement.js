	...
	function getAgreement(username,name,course,path,signDate,price,priceStandard,fmt){
		...
		if(fmt==="A2"){
			...
			arr.push('		</tr>');
			arr.push('		<tr>');
			arr.push('			<td colspan="2" style="height:30px;"><p style="font-size:1.3em;text-indent:3.5em;">1）乙方完成付费次日起的 3个自然日内，相关培训服务尚未实施前，乙方可以单方面解除本协议，并向甲方申请退回已交付的培训费，甲方收取30元服务费及书本费。</p></td>');
			arr.push('		</tr>');
			arr.push('		<tr>');
			arr.push('			<td colspan="2" style="height:30px;"><p style="font-size:1.3em;text-indent:3.5em;">2）乙方在开课前、付费超过3个自然日申请退学退费，甲方收取培训费5%服务费及书本费。</p></td>');
			arr.push('		</tr>');
			arr.push('		<tr>');
			...
			arr.push('		</tr>');
			arr.push('		<tr>');
			arr.push('			<td colspan="2" style="height:30px;"><p style="font-size:1.3em;text-indent:2em;">9、乙方上课期间必须自觉履行签到考勤制度，如本人没有签到，不来上课，作缺课处理，因缺课所产生的一切相关后果，均由乙方自行承担全部责任。</p></td>');
			arr.push('		</tr>');
			arr.push('		<tr>');
			arr.push('			<td colspan="2" style="height:30px;"><p style="font-size:1.3em;text-indent:2em;">10、乙方承诺报名的各项信息和资料真实、有效、正确，如乙方弄虚作假、不符合报名培训考试的规定而入学，所产生的一切后果自负，且一律不退任何费用。</p></td>');
			arr.push('		</tr>');
			arr.push('		<tr>');
			arr.push('			<td colspan="2" style="height:30px;"><p style="font-size:1.3em;text-indent:2em;">11、乙方报名后须关注该培训项目班级群内由学校发布的相关培训考试信息，如乙方因未关注班级群甲方的信息或手机号填写不正确而没有收到相关信息，乙方应承担由此而引起的一切责任。</p></td>');
			arr.push('		</tr>');
			arr.push('		<tr>');
			arr.push('			<td colspan="2" style="height:30px;"><p style="font-size:1.3em;text-indent:2em;">12、 其他条款：</p></td>');
			arr.push('		</tr>');
			arr.push('		<tr>');
