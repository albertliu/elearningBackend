...
<script language="javascript">
	...
	function getClassScheduleList(){
		$.get("classControl.asp?op=getClassSchedule&refID=" + nodeID + "&kindID=" + keyID + "&times=" + (new Date().getTime()),function(data){
			...
			arr.push("<th width='11%'>上课日期</th>");
			arr.push("<th width='2%'>周</th>");
			arr.push("<th width='10%'>教室</th>");
			arr.push("<th width='12%'>时间</th>");
			arr.push("<th width='4%'>时</th>");
			arr.push("<th width='8%'>教师</th>");
			arr.push("<th width='18%'>授课内容</th>");
			arr.push("<th width='11%'>形式</th>");
