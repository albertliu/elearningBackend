...
<script language="javascript">
	...
	function getStudentExamStat(){
		$.get("studentCourseControl.asp?op=getStudentExamStat&refID=" + nodeID + "&times=" + (new Date().getTime()),function(data){
			...
			arr.push("<th width='6%'>日期</th>");
			arr.push("<th width='4%'>No</th>");
			arr.push("<th width='10%'>考试名称</th>");
			arr.push("<th width='10%'>知识点</th>");
			arr.push("<th width='6%'>题目类型</th>");
			arr.push("<th width='13%'>得分</th>");
			arr.push("<th width='8%'>题目数量</th>");
			arr.push("<th width='6%'>正确数量%</th>");
			arr.push("</tr>");
			arr.push("</thead>");
	...
	<div style="width:100%;float:left;margin:0;">
		<div style="border:solid 1px #e0e0e0;width:99%;margin:1px;background:#ffffff;line-height:18px;">
			...
			<tr>
				...
				<td><input type="text" id="studentName" size="15" /></td>
				<td align="left"></td>
				<td>&nbsp;</td>
			</tr>
			</table>
