		...
		<div id="resume_print" style="border:none;width:100%;margin:1px;background:#ffffff;line-height:18px;">
			...
			<tr>
				<td align="center" height='48px;' colspan="5" class='table_resume_title' width='15%' height='250px;'>
					<span style="float:left;"><img id="img_cardA" src="" value="" style='width:340px;max-height:250px;border:none;' /></span>
					<span style="float:right;"><img id="img_cardB" src="" value="" style='width:340px;max-height:250px;border:none;' /></span>
				</td>
			</tr>
			<tr>
