...
<div id='layout' align='left' style="background:#f0f0f0;width:1000px;">	
	...
	<div style="width:100%;float:left;margin:0;">
		...
		<div id="resume_print" style="border:none;width:100%;margin:1px;background:#ffffff;line-height:18px;">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>姓名</td><td align="center" width='32%'><p style='font-size:0.85em;' id="name"></p></td>
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>身份证号</td><td align="center"><p style='font-size:0.85em;' id="username"></p></td>
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>年龄</td><td align="center" width='20%'><p style='font-size:0.85em;' id="age"></p></td>
				<td align="center" class='table_resume_title' width='16%'>民族</td><td align="center"><p style='font-size:0.85em;' id="ethnicity"></p></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>人员属性</td><td align="left">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>政治面貌</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>身份证地址</td><td align="center" colspan="4"><p style='font-size:0.85em;' id="IDaddress"></p></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>在职情况</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' height='35px;'>工作单位</td><td align="center" colspan="2"><p style='font-size:0.85em;' id="unit"></p></td>
				<td align="center" class='table_resume_title'>参加工作时间</td><td align="center"><input type="text" id="fire_employDate" style="width:100%;" /></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>从事职业</td><td align="center" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>所在学校</td><td align="center"><input type="text" id="fire_university" style="width:100%;" /></td>
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>学历</td><td align="center" colspan="2">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>专业名称</td><td align="center" colspan="4"><input type="text" id="fire_profession" style="width:100%;" /></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>手机号码</td><td align="center"><p style='font-size:0.85em;' id="mobile"></p></td>
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>详细地址</td><td align="center" colspan="4"><input type="text" id="fire_address" style="width:100%;" /></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>报考工种</td><td align="center" colspan="4"><p style='font-size:0.85em;' id="courseName"></p></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>职业方向</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>职业等级</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>鉴定分类</td><td align="left" colspan="4">
			...
			<tr id="item_kind7">
				<td align="center" class='table_resume_title' width='16%' height='35px;'>满足资格所属类</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>申报资格(中级)</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>申报资格(初级)</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='35px;'>*相关职业</td><td align="left" colspan="4">
