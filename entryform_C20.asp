	...
	function getNodeInfo(id,ref){
		...
		$.get("studentControl.asp?op=getNodeInfo&nodeID=0&refID=" + ref + "&times=" + (new Date().getTime()),function(re){
			...
			if(ar > ""){
				...
				if(c == ""){c = "&nbsp;&nbsp;身份证正面还未上传";}
				$("#img_cardA").html(c);
				getAgreement(ar[1],ar[2],course,(keyID==4?"":sign),sDate,price,priceStandard,agreement);
				k = 0;
				var p = 1;
				var s = 1;
				if(keyID != 4){
...
<div id='layout' align='left' style="background:#f0f0f0;width:1000px;">	
	...
	<div style="width:100%;float:left;margin:0;">
		...
		<div id="resume_print" style="border:none;width:100%;margin:1px;background:#ffffff;line-height:18px;">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>姓名</td><td align="center" width='32%'><p style='font-size:0.85em;' id="name"></p></td>
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>身份证号</td><td align="center"><p style='font-size:0.85em;' id="username"></p></td>
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>年龄</td><td align="center" width='20%'><p style='font-size:0.85em;' id="age"></p></td>
				<td align="center" class='table_resume_title' width='16%'>民族</td><td align="center"><p style='font-size:0.85em;' id="ethnicity"></p></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>人员属性</td><td align="left">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>政治面貌</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>身份证地址</td><td align="center" colspan="4"><p style='font-size:0.85em;' id="IDaddress"></p></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>在职情况</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' height='37px'>工作单位</td><td align="center" colspan="2"><p style='font-size:0.85em;' id="unit"></p></td>
				<td align="center" class='table_resume_title'>参加工作时间</td><td align="center"><input type="text" id="fire_employDate" style="width:100%;" /></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>从事职业</td><td align="center" colspan="4">
					...
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=3 />&nbsp;&nbsp;交运电信</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=4 />&nbsp;&nbsp;商业、饮食、物资供应和仓储</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=5 />&nbsp;&nbsp;房地产、公用事业、居民服务</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=6 />&nbsp;&nbsp;卫生体育福利</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=7 />&nbsp;&nbsp;教育文化广电</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=8 />&nbsp;&nbsp;科研技术服务</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=9 />&nbsp;&nbsp;金融保险</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=10 />&nbsp;&nbsp;机关社团</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind10" value=11 />&nbsp;&nbsp;其他</span>
				</td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>所在学校</td><td align="center"><input type="text" id="fire_university" style="width:100%;" /></td>
				<td align="center" class='table_resume_title'>学校类型</td><td align="center" colspan="2">
					...
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind3" value=2 />&nbsp;&nbsp;技校</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind3" value=3 />&nbsp;&nbsp;技师学院</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind3" value=4 />&nbsp;&nbsp;其他</span>
				</td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>学历</td><td align="center" colspan="2">
					...
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind12" value=3 />&nbsp;&nbsp;大专</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind12" value=4 />&nbsp;&nbsp;高中</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind12" value=5 />&nbsp;&nbsp;中专</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind12" value=6 />&nbsp;&nbsp;职高</span>
				</td>
				<td align="center" class='table_resume_title'>毕业时间</td><td align="center"><input type="text" id="fire_gradeDate" style="width:100%;" /></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>专业名称</td><td align="center" colspan="4"><input type="text" id="fire_profession" style="width:100%;" /></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>手机号码</td><td align="center"><p style='font-size:0.85em;' id="mobile"></p></td>
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>详细地址</td><td align="center" colspan="4"><input type="text" id="fire_address" style="width:100%;" /></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>报考工种</td><td align="center" colspan="4"><p style='font-size:0.85em;' id="courseName"></p></td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>职业方向</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>职业等级</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>鉴定分类</td><td align="left" colspan="4">
			...
			<tr id="item_kind7">
				<td align="center" class='table_resume_title' width='16%' height='37px'>满足资格所属类</td><td align="left" colspan="4">
			...
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>申报资格(中级)</td><td align="left" colspan="4">
					...
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind9" value=3 />&nbsp;&nbsp;累计从事相关职业工作6年（含）以上</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind9" value=4 />&nbsp;&nbsp;取的技工学校或相关专业毕业证书（含尚未取得毕业证书的在校应届毕业生）</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind9" value=5 />&nbsp;&nbsp;取得经评估论证、以中级技能为培养目标的中等及以上职业学校专业或相关专业毕业证书（含尚未取得毕业证书的在校应届毕业生）</span>
				</td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>申报资格(初级)</td><td align="left" colspan="4">
					...
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind9" value=9 />&nbsp;&nbsp;相关职业学徒期满</span>
				</td>
			</tr>
			<tr>
				<td align="center" class='table_resume_title' width='16%' height='37px'>*相关职业</td><td align="left" colspan="4">
					...
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=3 />&nbsp;&nbsp;安全评价工程技术人员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=4 />&nbsp;&nbsp;人民警察</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=5 />&nbsp;&nbsp;保卫管理员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=6 />&nbsp;&nbsp;消防员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=7 />&nbsp;&nbsp;消防指挥员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=8 />&nbsp;&nbsp;消防装备管理员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=9 />&nbsp;&nbsp;消防安全管理员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=10 />&nbsp;&nbsp;消防监督检查员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=11 />&nbsp;&nbsp;森林消防员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=12 />&nbsp;&nbsp;森林火情瞭望观察员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=13 />&nbsp;&nbsp;应急救援员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=14 />&nbsp;&nbsp;物业管理员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=15 />&nbsp;&nbsp;保安员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=16 />&nbsp;&nbsp;智能楼宇管理员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=17 />&nbsp;&nbsp;安全防范系统安装维护员</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=18 />&nbsp;&nbsp;机械设备安装工</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=19 />&nbsp;&nbsp;电气设备安装工</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=20 />&nbsp;&nbsp;管工</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=21 />&nbsp;&nbsp;电工</span>
					<span style='font-size:0.85em;'><input type="radio" name="fire_kind8" value=22 />&nbsp;&nbsp;安全员</span>
				</td>
			</tr>
			</table>
