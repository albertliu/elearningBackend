...
<script language="javascript">
	...
	function saveNode(){
		...
		$.get("studentCourseControl.asp?op=updateFiremanEnterInfo&refID=" + nodeID + "&area=" + escape($("#fire_area").val()) + "&address=" + escape($("#fire_address").val())+ "&employDate=" + $("#fire_employDate").val() + "&university=" + escape($("#fire_university").val()) + "&profession=" + escape($("#fire_profession").val()) + "&gradeDate=" + $("#fire_gradeDate").val() + "&area_now=" + escape($("#fire_area_now").val()) + "&kind1=" + $("input[name='fire_kind1']:checked").val() + "&kind2=" + $("input[name='fire_kind2']:checked").val() + "&kind3=" + $("input[name='fire_kind3']:checked").val() + "&kind4=" + $("input[name='fire_kind4']:checked").val() + "&kind5=" + $("input[name='fire_kind5']:checked").val() + "&kind6=" + $("input[name='fire_kind6']:checked").val() + "&kind7=" + $("input[name='fire_kind7']:checked").val() + "&kind8=" + $("input[name='fire_kind8']:checked").val() + "&kind9=" + $("input[name='fire_kind9']:checked").val() + "&kind10=" + $("input[name='fire_kind10']:checked").val() + "&kind11=" + $("input[name='fire_kind11']:checked").val() + "&kind12=" + $("input[name='fire_kind12']:checked").val() + "&memo=" + escape($("#fire_memo").val()) + "&times=" + (new Date().getTime()),function(re){
			//alert(unescape(re));
			var ar = new Array();
			ar = unescape(re).split("|");
			if(ar[0] == 0){
