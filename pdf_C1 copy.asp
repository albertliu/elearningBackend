...
<section class="login-form-wrap3">
	...
	<div style="position: absolute; z-index:20;padding-top:5mm;padding-left:210mm;">
		<img id="photo_filename" src="" style="width:40mm;max-height:60mm;">
	</div>
	<div style="text-align:center; padding-top:15px;"><h2>安全培训合格证书</h2></div>
	<div style="position: absolute; z-index:10; width:100%; padding-left:10mm;padding-top:10mm;">
		<div class="lineC1"><span id="name" style="padding-left:10mm;"></span><span style="padding-left:5mm;">同志于</span><span id="class_startDate" style="padding-left:5mm;"></span></div>
		<div class="lineC1"><span>至</span><span id="class_endDate" style="padding-left:5mm;"></span><span style="padding-left:5mm;">参加危险化学</span></div>
		<div class="lineC1"><span>品从业人员安全培训，完成了</span></div>
		<div class="lineC1"><span>规定课程的学习，经考核合格，</span></div>
		<div class="lineC1"><span>特发此证。</span></div>
	...
	<div style="position: absolute; z-index:30;padding-top:65mm;padding-left:35mm;">
