	...
	<div style="width:100%;float:left;margin:0;">
		<div id="resume_print" style="border:none;width:100%;margin:1px;background:#ffffff;line-height:18px;">
			<div style="position: relative;">
				...
				<tr>
					<td align="center" class='table_resume_title' height='40px;' style="border-bottom-style:none;">
						<div style='margin: 10px;text-align:center;'><h2 style='font-size:2.8em; margin:30px 0 10px 0;'>上海市特种作业培训证明</h2></div>
				...
				<tr>
					<td class='table_resume_title' height='30px;' style="border-bottom-style:none; border-top-style:none;">
						<div style='float:left; margin:20px 0 10px 0; padding-left:30px;'><span class='h3'>上海市安全生产资格考试机构（上海市安全生产科学研究所）:</span></div>
					</td>
				</tr>
				<tr>
					<td align="left" class='table_resume_title' height='40px;' style="border-bottom-style:none; border-top-style:none;">
						<div style='float:left;margin:20px; padding-left:10px; text-align: left; line-height: 2; text-indent:4em;'>
				...
				<tr>
					<td class='table_resume_title' height='30px;' style="border-bottom-style:none; border-top-style:none;">
						<div style='float:left; margin:20px 0 20px 0; padding-left:150px;'>
				...
				<tr>
					<td class='table_resume_title' height='30px;' style="border-bottom-style:none; border-top-style:none;">
						<div style='float:left; margin:10px 0 10px 0; padding-left:180px;display: table-cell;vertical-align: middle;'>
				...
				<tr>
					<td class='table_resume_title' height='30px;' style="border-bottom-style:none; border-top-style:none;">
						<div style='float:right; margin:10px 0 10px 0; padding-right:50px;'>
				...
				<tr>
					<td class='table_resume_title' height='30px;' style="border-bottom-style:none; border-top-style:none;">
						<div style='float:left; margin:20px; padding-left:10px;text-align: left; line-height: 1.8;'>
				...
				<div style="float:center; text-align:center;">
					<span><img id="stamp" src="" style="width:200px;margin:0px 0px 8px 350px;padding-left:30px;padding-top:400px;opacity:0.7;"></span>
				</div>
				</div>
			</div>
		</div>
