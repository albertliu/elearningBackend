...
<div id='layout' align='left' style="background:#f0f0f0;">	
	...
	<div style="width:100%;float:left;margin:0;">
		...
		<div id="resume_print" style="border:none;width:100%;margin:1px;background:#ffffff;line-height:18px;">
			...
			<tr>
				<td align="center" class='table_resume_title' width='20%' height='48px;'>姓名</td><td align="center" width='25%'><p style='font-size:1em;' id="name"></p></td>
			...
			<tr>
				<td align="center" class='table_resume_title' height='48px;'>户籍所在地(户口或居住证)</td>
				<td align="center">
				</td>
			...
			<tr>
				<td align="center" height='48px;' colspan="5" class='table_resume_title' width='15%' height='250px;'>
					<span style="float:left;"><img id="img_cardA" src="" value="" style='width:340px;border:none;' /></span>
					<span style="float:right;"><img id="img_cardB" src="" value="" style='width:340px;border:none;' /></span>
				</td>
			</tr>
			<tr id="material">
				<td align="center" class='table_resume_title' width='15%' height='120px;'>相关资料</td>
				<td align="left" colspan="7" style="padding-left:5px;">
					<p style='font-size:1em;'><input type="checkbox" checked="" />&nbsp;&nbsp;身份证明（复印件1份）</p>
					<p style='font-size:1em;'><input type="checkbox" checked="" />&nbsp;&nbsp;学历证明（复印件1份）</p>
					<p style='font-size:1em;'><input type="checkbox" />&nbsp;&nbsp;体检报告（1份，相应考试大纲有要求的）</p>
				</td>
			</tr>
			<tr>
