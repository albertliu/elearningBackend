...
if(op == "update"){
	result = 0;
	if(result == 0){
		sql = "exec updateCourseInfo " + nodeID + ",'" + String(Request.QueryString("courseID")) + "','" + unescape(String(Request.QueryString("courseName"))) + "','" + String(Request.QueryString("hours")) + "'," + kindID + "," + status + ",'" + refID + "','" + host + "','" + memo + "','" + currUser + "'";
