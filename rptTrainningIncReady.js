	$(document).ready(function (){
        getComboList("rptTrainningSales","userInfo","username","realName","host='" + currHost + "' and username in(select username from roleUserList where roleID='saler') order by status, realName",1);
