...
************************************************************************************************************/
	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = 'images/tabView/tab_right_inactive.gif';
		...
		img.src = 'images/tabView/tab_right_active.gif';
	...
	function tabClick()
	{
		...
		var i = idArray[idArray.length-1].replace(/[^0-9]/gi,'');
		showTab(this.parentNode.parentNode.id,i);
		reloadData(i);
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = 'images/tabView/tab_right_over.gif';
		}
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab)
	{
		...
		for(var no=0;no<tabTitles.length;no++){
			...
			if(closeButtonArray[no]){
				...
				closeButton.src = 'images/tabView/close.gif';
