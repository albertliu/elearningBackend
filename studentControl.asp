...
if(op == "getNodeInfo"){
	...
	if(!rs.EOF){
		...
		//43
		result += "|" + rs("CHESICC_filename").value + "|" + rs("employe_filename").value + "|" + rs("job_filename").value + "|" + rs("linker").value;
	}
	rs.Close();
	Response.Write(escape(result));
}	
...
if(op == "update"){
	...
	if(result == 0){
		...
		sql = "exec updateStudentInfo " + keyID + ",'" + nodeID + "','" + unescape(String(Request.QueryString("name"))) + "',''," + kindID + ",'" + String(Request.QueryString("companyID")) + "','" + String(Request.QueryString("dept1")) + "','','" + String(Request.QueryString("dept2")) + "','','" + unescape(String(Request.QueryString("job"))) + "','" + unescape(String(Request.QueryString("linker"))) + "'," + String(Request.QueryString("job_status")) + ",'" + unescape(String(Request.QueryString("mobile"))) + "','" + unescape(String(Request.QueryString("phone"))) + "','" + unescape(String(Request.QueryString("email"))) + "','" + unescape(String(Request.QueryString("address"))) + "','" + String(Request.QueryString("limitDate")) + "','" + String(Request.QueryString("education")) + "','" + unescape(String(Request.QueryString("unit"))) + "','" + unescape(String(Request.QueryString("dept"))) + "','" + unescape(String(Request.QueryString("ethnicity"))) + "','" + unescape(String(Request.QueryString("IDaddress"))) + "','" + unescape(String(Request.QueryString("bureau"))) + "','" + String(Request.QueryString("IDdateStart")) + "','" + String(Request.QueryString("IDdateEnd")) + "','" + unescape(String(Request.QueryString("experience"))) + "','" + memo + "','" + host + "','" + currUser + "'";
		execSQL(sql);
	}
